...
import { videosData } from './logic/Videos';
import { useRouter } from 'next/router';

const videos = videosData.map((video, id) => ({
    id,
    name: video.name,
    href: `/watch/${video.nftMetadataCid}`,
}));
        ...
        open
            ...
            : <>
                ...
                <button className='md:hidden' onClick={() => setOpen(true)}>
                    <svg xmlns="http://www.w3.org/2000/svg" className="pointer-events-none h-6 w-6 text-gray-400" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" />
                    </svg>
                </button>
            </>
