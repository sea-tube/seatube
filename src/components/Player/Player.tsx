...
export default function Player({
  ...
  const [showPeers, setShowPeers] = useState<boolean>(false)
  ...
  useEffect(() => {
    if (
      (isMobile && config.nativeFullScreen.mobile) ||
        ...
        videoRef.current.addEventListener(
          ...
          () => {
            if (
              ...
              document.fullscreenElement.id == 'video'
            ) {
              reportFullScreenOn()
            } else {
              reportFullScreenOff()
    ...
    <>
      <div id="seaPlayer" className={styles.player} ref={playerRef}>
        ...
        <div
          ...
          className={styles.videoPlayToggle}
          onClick={togglePlay}
          style={{
        ...
        >
          ...
          >
            ...
            {((!videoPlay && canPlay && animating != 'pausing') ||
              animating == 'playing') && (
              <PlayIcon
                style={{
                  width: '50%',
        ...
        >
          ...
          <div id="loaded-title" className={styles.loadedTitle}>
        ...
        <div className={styles.controls}>
          <Controls
            ...
            videoRef={videoRef}
            onFullScreen={(status) =>
              status ? enableFullScreen() : disableFullScreen()
            }
            ...
            onPeers={() => setShowPeers(!showPeers)}
          />
        </div>
